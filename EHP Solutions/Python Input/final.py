...
# Connection string for destination (kept the same)
...
def dynamic_data_transfer_with_procedure(source_conn_str, source_table, source_processed_table, destination_conn_str, procedure_name):
    try:
...
if __name__ == '__main__':
    # Get user input for source connection string
    print("Enter the source connection string parameters:")
    source_server = input("Server: ")
    source_database = input("Database: ")
    source_uid = input("User ID: ")
    source_pwd = input("Password: ")
    ...
    # Get user input for source table and processed table
    source_table = input("Enter the source table name: ")
    source_processed_table = input("Enter the name for the processed table in the source database: ")

    # config_file = 'config.json'  # JSON configuration file where the client can specify tables
    # config = load_config(config_file)

    # Get the stored procedure name from the config
    procedure_name = "ProcessMedScreeningData"

    dynamic_data_transfer_with_procedure(source_conn_str, source_table, source_processed_table, destination_conn_str, procedure_name)